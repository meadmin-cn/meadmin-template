<template>
  <el-scrollbar view-class="layout-menu-content" class="layout-menu"
...
const menuBg1 = computed(() => mixColor(themeConfig.menuBg, getColorLuma(themeConfig.menuBg) < 100 ? '#ffffff' : '#303133', 0.1))
